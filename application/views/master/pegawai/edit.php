<div class="modal fade" id="modal_edit">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('master/Kepegawaian/update', ['id' => 'edit', 'class' => 'form_edit'], ['kode' => $data['kode_pegawai']]) ?>
			<div class="modal-body">
				<div class="form-group">
					<label>Kode Kepegawaian</label>
					<input type="text" name="kode" class="form-control" value="<?= $data['kode_pegawai'] ?>" readonly="disabled">
					<span class="error kode text-red"></span>
				</div>

				<div class="form-group">
					<label>Status Pegawai</label>
					<input type="text" name="status" class="form-control" value="<?= $data['status_pegawai'] ?>">
